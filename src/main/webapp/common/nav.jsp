    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li  id="li_10"><a href="/brand/toList.jhtml#10">品牌管理</a></li>
                <li  id="li_8"><a href="/spec/toList.jhtml#8">规格管理</a></li>
                <li id="li_2"><a href="/user/toList.jhtml#2">用户管理</a></li>
                <li id="li_12"><a href="/member/index.jhtml#12">会员管理</a></li>
        ...
        $.ajaxSetup({
            ...
            complete:
                function (XMLHttpRequest, textStatus) {
                    ...
                    if (result.code == -1) {
                        bootbox.alert({
                            message: "<span class='glyphicon glyphicon-exclamation-sign'></span><b><font color='red'>o(╥﹏╥)o系统错误，请联系管理员！！！</font></b>",
                            size: 'small',
                            title: "提示信息"
                        });
                    }
